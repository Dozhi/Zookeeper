...
fun main() {
    var done = false
    println("Welcome to Zoo! We have 6 animals right now!\n" +
            "You can select animal by inputting number from 1 to 6 to the console\n" +
            "If you want to exit Zoo, please write 'exit'")
    do {
